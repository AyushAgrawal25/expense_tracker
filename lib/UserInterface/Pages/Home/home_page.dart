...
class _HomePageState extends State<HomePage> {
  ...
  void onRefreshPressed() async {
    int id = 0;
    sampleUPIMessages.forEach((msg) {
      SMSTransactionData? smsTransactionData =
          SMSTransactionUtils.getTransactionData(msg, DateTime.now(), id);
      logger.i('SMS Transaction Data:');
      logger.i(smsTransactionData?.toJson());
      id++;
    });
